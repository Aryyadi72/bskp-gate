                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('assets-main/assets/images/logo-icon.png') }}" alt="homepage"
                                class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('assets-main/assets/images/logo-text.png') }}" alt="homepage"
                                class="light-logo" />
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Selamat Datang, <span class="text-info">Ahmad Aryyadi Setiawan.</span>
                        </h4>
